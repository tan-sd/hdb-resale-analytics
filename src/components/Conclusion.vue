...
const steps = [
  {
    ...
    description: ['<span class="font-semibold">Macro factors</span> shape systemic forces like policy, location, and demographics. <span class="font-semibold">Micro factors</span> reflect specific features of flats that buyers compare — like size, floor level, or MRT proximity.'],
    highlighted: [],
    layout: 'split',
  },
  {
    header: 'Most to Least Influential',
    description: ['Here are the factors sorted by their <span class="font-semibold">influence on resale prices</span>, from strongest to weakest. Macro factors tend to lead, with micro traits offering premiums.'],
    highlighted: [],
    layout: 'ranked',
  },
  {
    header: '\ud83e\udd47 Top Tier \u2014 Strongest Influence',
    description: ['Systemic drivers like <span class="font-semibold">government policy</span> and <span class="font-semibold">planning area</span> shape trends, while flat traits like <span class="font-semibold">size</span> and <span class="font-semibold">storey level</span> strongly impact value.'],
    highlighted: ['Government Policy', 'Planning Area', 'Flat Type & Size', 'Storey Level'],
    layout: 'ranked',
  },
  {
    header: '\ud83e\udd48 Middle Tier \u2014 Moderate Impact',
    description: ['Factors like <span class="font-semibold">MRT proximity</span>, <span class="font-semibold">lease years</span>, and <span class="font-semibold">schools</span> matter, but with nuanced and group-specific effects.'],
    highlighted: ['Proximity to MRT', 'Years Remaining on Lease', 'Proximity to Schools'],
    layout: 'ranked',
  },
  {
    header: '\ud83e\udd49 Lower Tier \u2014 Indirect Influence',
    description: ['<span class="font-semibold">Demographics</span> and <span class="font-semibold">electoral zones</span> shape long-term planning more than prices.'],
