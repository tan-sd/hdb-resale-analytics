...
const steps = [
    ...
    },
    {
        ...
        description: [
            ...
            'Some areas — such as <span class="font-semibold">Bukit Merah</span> — may show wider spreads due to <span class="font-semibold">fewer transactions</span> or <span class="font-semibold">outlier sales</span>, like rare flat types or unusually large units.',
        ],
